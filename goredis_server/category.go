...
// 需要同步到从库的命令
var syncCmdlist = "SET,INCR,DECR,INCRBY,DECRBY,MSET,HDEL,HSET,HMSET,HINCRBY,LPOP,LPUSH,LREM,RPOP,RPUSH,SADD,SREM,ZADD,ZINCRBY,ZREM,DEL,EXPIRE,RAW_SET,RAW_SET_NOREPLY"
