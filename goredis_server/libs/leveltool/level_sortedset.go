...
func (l *LevelSortedSet) infoKey() []byte {
	return joinStringBytes(KEY_PREFIX, SEP_LEFT, l.entryKey, SEP_RIGHT, ZSET_SUFFIX)
}
...
func (l *LevelSortedSet) memberKey(member []byte) []byte {
	return joinStringBytes(ZSET_PREFIX, SEP_LEFT, l.entryKey, SEP_RIGHT, "member", SEP, string(member))
}

// __zset[user_rank]
func (l *LevelSortedSet) keyPrefix() []byte {
	return joinStringBytes(ZSET_PREFIX, SEP_LEFT, l.entryKey, SEP_RIGHT)
}

// __zset[user_rank]score#
func (l *LevelSortedSet) scoreKeyPrefix() []byte {
	return joinStringBytes(ZSET_PREFIX, SEP_LEFT, l.entryKey, SEP_RIGHT, "score", SEP)
}
...
func (l *LevelSortedSet) baseScoreKey(score []byte) (key []byte) {
	...
	return joinStringBytes(ZSET_PREFIX, SEP_LEFT, l.entryKey, SEP_RIGHT, "score", SEP, zero, string(score), SEP)
}
...
func (l *LevelSortedSet) joinScoreKeyWithSuffix(suffix []byte) (key []byte) {
	return joinStringBytes(ZSET_PREFIX, SEP_LEFT, l.entryKey, SEP_RIGHT, "score", SEP, string(suffix))
}
